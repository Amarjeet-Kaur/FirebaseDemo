...
<h4>Usage</h4><br>
<p>
1. Create a project in android and register that project with firebase and download the <q><italics>google-services.json</italics></q> file, add that file to the android project.<br>
